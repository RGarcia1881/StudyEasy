...
const RecentClassesHome = () => {
  ...
  useEffect(() => {
    const loadClasses = () => {
      ...
      // Eliminar el filtro de la materia para mostrar todas las clases recientes
      setRecentClasses(storedClasses.slice(0, 4));
    };
    loadClasses();
  }, []);
...
export default RecentClassesHome;
